@extends('layouts.chapter_three_layout')
...
<div id = "game_prompt_assessment_result_id" class = "game_prompt_assessment_result_container customize_hide_element">
    ...
    <div class = "game_prompt_assessment_result_content">
        ...
        <button id = "game_assessment_result_revert_id" data-assessment-revert-current-scene-id = "" class = "game_prompt_assessment_result_content_button customize_prompt_assessment_result_backgroundgreen customize_hide_element" type = "button">Go back to Chapter 3 <i class="fa fa-undo"></i></button>
        <button id = "game_assessment_result_next_id" data-assessment-result-current-scene-id = "" data-assessment-result-next-scene-id = "" class = "game_prompt_assessment_result_content_button customize_hide_element" type = "button">Next <i class="fa fa-check"></i></button>

    </div>
</div>

<div id = "game_prompt_awarding_id" class = "game_prompt_awarding_container customize_hide_element">

    <div class = "game_prompt_awarding_content">

        <div id = "game_awarding_title_id" class = "game_prompt_awarding_content_title">
        </div>

        <div id = "game_awarding_text_id" class = "game_prompt_awarding_content_text">
        </div>

        <div id = "game_awarding_score_id" class = "game_prompt_awarding_content_score">
        </div>

        <div class = "game_prompt_awarding_content_note">
        Note: Please take a screenshot of your certificate and send it together with your previous screenshots. Email: agtarap.llb@pnu.edu.ph
        </div>
...
<div id = "find_object_container_id" class = "customize_hide_element">
    ...
    <div class = "object_container_1">
        <div data-object-image-id = "4" data-chapter-scene-id = "6" class = "object_dialog_image">
            <img class = "object_container_1_img" src = "rod.png"/>
        </div>
    ...
    <div class = "object_container_2">
        <div data-object-image-id = "3" data-chapter-scene-id = "6" class = "object_dialog_image">
            <img class = "object_container_2_img" src = "stethoscope.png"/>
        </div>
    ...
    <div class = "object_container_3">
        <div data-object-image-id = "2" data-chapter-scene-id = "6" class = "object_dialog_image">
            <img class = "object_container_3_img" src = "steering.png"/>
        </div>
    ...
    <div class = "object_container_4">
        <div data-object-image-id = "1" data-chapter-scene-id = "6" class = "object_dialog_image">
            <img class = "object_container_4_img" src = "telescope.png"/>
        </div>
...
$(document).ready(function()
{
    ...
    $('.object_dialog_image').click(function()
    {
        ...
        else
        {
            ...
            for(i = 0; i < global_chapter_list['chapter_three']['chapter_scenes'].length; i++)
            {
                if(chapter_scene_id == global_chapter_list['chapter_three']['chapter_scenes'][i]['id'])
                {
                    for(j = 0; j < global_chapter_list['chapter_three']['chapter_scenes'][i]['find_object'].length; j++)
                    {
                        if(id == global_chapter_list['chapter_three']['chapter_scenes'][i]['find_object'][j]['id'])
                        {
                            $('div[data-object-dialog-id="'+ id +'"]').text(global_chapter_list['chapter_three']['chapter_scenes'][i]['find_object'][j]['message']);

                            global_chapter_list['chapter_three']['chapter_scenes'][i]['find_object'][j]['is_read'] = 1;
                        }
                    }
                }
            }
    ...
    $('#game_scene_previous_id').on('click', function()
    {
        ...
        for(i = 0; i < global_chapter_list['chapter_three']['chapter_scenes'].length; i++)
        {
            global_chapter_list['chapter_three']['chapter_scenes'][i]['is_current_selected'] = 0;
        }

        for(i = 0; i < global_chapter_list['chapter_three']['chapter_scenes'].length; i++)
        {
            let id = global_chapter_list['chapter_three']['chapter_scenes'][i]['id'];

            if(current_scene == id)
            {
                global_chapter_list['chapter_three']['chapter_scenes'][i]['is_read'] = 1;
            }

            if(next_scene == id)
            {
                global_chapter_list['chapter_three']['chapter_scenes'][i]['is_current_selected'] = 1;
            }
        }
    ...
    $('#game_scene_next_id').on('click', function()
    {
        ...
        for(i = 0; i < global_chapter_list['chapter_three']['chapter_scenes'].length; i++)
        {
            ...
            if(current_scene == id)
            {
                ...
                if(next_scene_type == "is_poem_question")
                {
                    global_chapter_list['chapter_three']['chapter_scenes'][i]['poem_question_and_answer']['answer'] = $('#game_question_text_id').val();
                }
            }
    ...
    $('#game_assessment_next_id').on('click', function()
    {
        ...
        if(is_chosen == true)
        {
            for(i = 0; i < global_chapter_list['chapter_three']['chapter_scenes'].length; i++)
            {
                for(j = 0; j < global_chapter_list['chapter_three']['chapter_scenes'][i]['assessment'].length; j++)
                {
                    global_chapter_list['chapter_three']['chapter_scenes'][i]['assessment'][j]['is_current_selected'] = 0;
                }
            }
            ...
            for(i = 0; i < global_chapter_list['chapter_three']['chapter_scenes'].length; i++)
            {
                for(j = 0; j < global_chapter_list['chapter_three']['chapter_scenes'][i]['assessment'].length; j++)
                {
                    let id = global_chapter_list['chapter_three']['chapter_scenes'][i]['assessment'][j]['id'];

                    if(current_scene == id)
                    {
                        global_chapter_list['chapter_three']['chapter_scenes'][i]['assessment'][j]['is_read'] = 1;

                        if(letter_chosen == "a")
                        {
                            global_chapter_list['chapter_three']['chapter_scenes'][i]['assessment'][j]['answer'] = letter_chosen;
                        }
                    ...
                    if(next_scene == id)
                    {
                        global_chapter_list['chapter_three']['chapter_scenes'][i]['assessment'][j]['is_current_selected'] = 1;
                    }
                }
            }
    ...
    $('#game_assessment_result_revert_id').on('click', function()
    {
        ...
        for(i = 0; i < global_chapter_list['chapter_three']['chapter_scenes'].length; i++)
        {
            global_chapter_list['chapter_three']['chapter_scenes'][i]['is_read'] = 0;
            global_chapter_list['chapter_three']['chapter_scenes'][i]['is_current_selected'] = 0;
        }

        for(i = 0; i < global_chapter_list['chapter_three']['chapter_scenes'].length; i++)
        {
            if(global_chapter_list['chapter_three']['chapter_scenes'][i]['poem_question_and_answer'] != null)
            {
                global_chapter_list['chapter_three']['chapter_scenes'][i]['poem_question_and_answer']['answer'] = '';
            }

            for(j = 0; j < global_chapter_list['chapter_three']['chapter_scenes'][i]['find_object'].length; j++)
            {
                global_chapter_list['chapter_three']['chapter_scenes'][i]['find_object'][j]['is_read'] = 0;
                global_chapter_list['chapter_three']['chapter_scenes'][i]['find_object'][j]['is_current_selected'] = 0;
            }

            for(j = 0; j < global_chapter_list['chapter_three']['chapter_scenes'][i]['assessment'].length; j++)
            {
                global_chapter_list['chapter_three']['chapter_scenes'][i]['assessment'][j]['answer'] = '';
                global_chapter_list['chapter_three']['chapter_scenes'][i]['assessment'][j]['is_read'] = 0;
                global_chapter_list['chapter_three']['chapter_scenes'][i]['assessment'][j]['is_current_selected'] = 0;
            }
        }
    ...
    {
        let current_scene = $(this).attr('data-assessment-result-current-scene-id'),
            next_scene = $(this).attr('data-assessment-result-next-scene-id'),
            next_scene_type = $(this).attr('data-next-scene-type');
    ...
    function get_user_chapter()
    {
        $.ajax({
            ...
            success: function(result)
            {
                ...
                {
                    let chapter_list = result['data']['chapter_three']['chapter_scenes'],
                        chapter_three_answer_key_list = result['data']['chapter_three']['assessment_answer_keys'],
                        character_detail = result['user_detail'];
                    ...
                    if(chapter_list.length > 0)
                    {
                        for(i = 0; i < chapter_list.length; i++)
                        {
                            ...
                            if(is_read == 0)
                            {
                                chapter_process(chapter_scene_id, chapter_list, chapter_three_answer_key_list, character_detail);
                            }
                            else
                            {
    ...
    function chapter_process(chapter_scene_id, chapter_list, chapter_three_answer_key_list, character_detail)
    {
        for(i = 0; i < chapter_list.length; i++)
        {
            let id = chapter_list[i]['id'],
                ...
                is_awarding = chapter_list[i]['is_awarding'],
                is_read = chapter_list[i]['is_read'],
                is_current_selected = chapter_list[i]['is_current_selected'];
            ...
            if(id == chapter_scene_id)
            {
                ...
                else if(is_prompt == 1)
                {
                    ...
                    if(message.length >= 969)
                    {
                        $('#game_text_id').addClass('customize_fontsize15px');
                    }
                    else
                    {
                        $('#game_text_id').removeClass('customize_fontsize15px');
                    }
                ...
                else if(is_assessment_question == 1)
                {
                    ...
                    if(assessment_all_answered == true)
                    {
                        ...
                        for(j = 0; j < assessment.length; j++)
                        {
                            for(k = 0; k < chapter_three_answer_key_list.length; k++)
                            {
                                if(assessment[j]['id'] == chapter_three_answer_key_list[k]['id'])
                                {
                                    if(assessment[j]['answer'] == chapter_three_answer_key_list[k]['answer'])
                                    {
                        ...
                        for(j = 0; j < chapter_three_answer_key_list.length; j++)
                        {
                            answer_keys += chapter_three_answer_key_list[j]['id'] + '. ' + chapter_three_answer_key_list[j]['answer'].toUpperCase() + ' ';
                        }

                        if(total_correct_answer >= 6)
                        {
                            $('#game_assessment_result_title_id').html('Congratulations! You found the archive.');
                        ...
                        {
                            $('#game_assessment_result_title_id').text('Oh! We are almost done. Let’s try again!');
                    ...
                    $('#game_assessment_result_next_id').attr('data-assessment-result-current-scene-id', next_data_current_scene);
                    $('#game_assessment_result_next_id').attr('data-assessment-result-next-scene-id', next_data_next_scene);

                    $('#game_scene_next_id').attr('data-next-scene-type', "");
                }
                else if(is_awarding == 1)
                {
                    hide_game_prompt();
                    hide_game_prompt_question();
                    hide_find_object();
                    ...
                    let chapter_one_total_correct_answer = 0,
                        chapter_two_total_correct_answer = 0,
                        chapter_three_total_correct_answer = 0,
                        chapter_one_question_length = 0,
                        chapter_two_question_length = 0,
                        chapter_three_question_length = 0;

                    for(j = 0; j < global_chapter_list['chapter_one']['chapter_scenes'].length; j++)
                    {
                        if(global_chapter_list['chapter_one']['chapter_scenes'][j]['is_assessment_question'] == 1)
                        {
                            chapter_one_question_length = global_chapter_list['chapter_one']['chapter_scenes'][j]['assessment'].length;

                            for(k = 0; k < global_chapter_list['chapter_one']['chapter_scenes'][j]['assessment'].length; k++)
                            {
                                for(l = 0; l < global_chapter_list['chapter_one']['assessment_answer_keys'].length; l++)
                                {
                                    if(global_chapter_list['chapter_one']['chapter_scenes'][j]['assessment'][k]['id'] == global_chapter_list['chapter_one']['assessment_answer_keys'][l]['id'])
                                    {
                                        if(global_chapter_list['chapter_one']['chapter_scenes'][j]['assessment'][k]['answer'] == global_chapter_list['chapter_one']['assessment_answer_keys'][l]['answer'])
                                        {
                                            chapter_one_total_correct_answer++;
                                        }
                    ...
                    for(j = 0; j < global_chapter_list['chapter_two']['chapter_scenes'].length; j++)
                    {
                        if(global_chapter_list['chapter_two']['chapter_scenes'][j]['is_assessment_question'] == 1)
                        {
                            chapter_two_question_length = global_chapter_list['chapter_two']['chapter_scenes'][j]['assessment'].length;

                            for(k = 0; k < global_chapter_list['chapter_two']['chapter_scenes'][j]['assessment'].length; k++)
                            {
                                for(l = 0; l < global_chapter_list['chapter_two']['assessment_answer_keys'].length; l++)
                                {
                                    if(global_chapter_list['chapter_two']['chapter_scenes'][j]['assessment'][k]['id'] == global_chapter_list['chapter_two']['assessment_answer_keys'][l]['id'])
                                    {
                                        if(global_chapter_list['chapter_two']['chapter_scenes'][j]['assessment'][k]['answer'] == global_chapter_list['chapter_two']['assessment_answer_keys'][l]['answer'])
                                        {
                                            chapter_two_total_correct_answer++;
                                        }
                    ...
                    for(j = 0; j < global_chapter_list['chapter_three']['chapter_scenes'].length; j++)
                    {
                        if(global_chapter_list['chapter_three']['chapter_scenes'][j]['is_assessment_question'] == 1)
                        {
                            chapter_three_question_length = global_chapter_list['chapter_three']['chapter_scenes'][j]['assessment'].length;

                            for(k = 0; k < global_chapter_list['chapter_three']['chapter_scenes'][j]['assessment'].length; k++)
                            {
                                for(l = 0; l < global_chapter_list['chapter_three']['assessment_answer_keys'].length; l++)
                                {
                                    if(global_chapter_list['chapter_three']['chapter_scenes'][j]['assessment'][k]['id'] == global_chapter_list['chapter_three']['assessment_answer_keys'][l]['id'])
                                    {
                                        if(global_chapter_list['chapter_three']['chapter_scenes'][j]['assessment'][k]['answer'] == global_chapter_list['chapter_three']['assessment_answer_keys'][l]['answer'])
                                        {
                                            chapter_three_total_correct_answer++;
                                        }
                    ...
                    let total_chapter_correct_answer = chapter_one_total_correct_answer + chapter_two_total_correct_answer + chapter_three_total_correct_answer,
                        total_chapter_question_length = chapter_one_question_length + chapter_two_question_length + chapter_three_question_length
console.log(character_detail)
                    $('#game_awarding_title_id').text(character_detail['name']);
                    $('#game_awarding_text_id').text(character_detail['year_level']);
                    $('#game_awarding_score_id').text(total_chapter_correct_answer + '/' + total_chapter_question_length);
                }
            }
        }
    ...
    function show_game_prompt_awarding()
    {
        $('#game_prompt_awarding_id').removeClass('customize_hide_element');
    }
    ...
    function hide_game_prompt_awarding()
    {
        $('#game_prompt_awarding_id').addClass('customize_hide_element');
    }
