...
<html lang>
    <head>
        <title>Lost Archive - Chapter 3</title>
        ...
        <link href = "game_prompt_awarding.css" rel = "stylesheet"/>
        ...
        *
        ...
        .chapter_background
        {
            ...
            position: absolute;
            top: 0px;
            background-image: url("chapter_three_background_v1.jpg"); /* The image used */
